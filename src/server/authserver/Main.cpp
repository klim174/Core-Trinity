...
extern int main(int argc, char** argv)
{
    ...
    TC_LOG_INFO(LOG_FILTER_AUTHSERVER, " ApocalypseEmu Community developers(c) 2013 ");
    TC_LOG_INFO(LOG_FILTER_AUTHSERVER, " Desarrollado por ApocalypseEmu basado en TrinityCore y MaNGOS Two ");
    TC_LOG_INFO(LOG_FILTER_AUTHSERVER, " https://ApocalypseCore.tk/ ");
    TC_LOG_INFO(LOG_FILTER_AUTHSERVER, " Presione <Ctrl-C> para detenerlo.\n");
	
    TC_LOG_INFO(LOG_FILTER_AUTHSERVER, "El archivo de configuration usado es %s.", configFile);
